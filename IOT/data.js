    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          ...
          "c": "Harvard-Princeton Hybrid Architecture",
          "d": "Dual-Bus RISC Architecture"
        },
        "correct": "b"
      },
      {
      ...
      },
      {
        ...
        "options": {
          "a": "Intel Core i7-13700K",
          "b": "**ATmega328P (used in Arduino Uno) ✓**",
          "c": "NVIDIA RTX 4090 GPU",
          "d": "AMD Ryzen 5 5600X"
        },
        "correct": "b"
      },
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          "a": "Its resistance increases significantly",
          "b": "**Its resistance decreases significantly ✓**",
          "c": "It generates an electrical current directly",
          "d": "Its capacitance changes"
        },
        "correct": "b"
      },
      {
      ...
      },
      {
        ...
        "options": {
          ...
          "c": "RC oscillators require external quartz inputs",
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          "a": "Standard mainframe batch compiling",
          "b": "**Smart Cities, Smart Grid, and Industrial Automation ✓**",
          "c": "Offline magnetic tape storage",
          "d": "Unshielded copper bus topologies"
        },
        "correct": "b"
      },
      {
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          "a": "`temp = val * 5.0;`",
          "b": "**`temp = (val * 5.0 * 100.0) / 1024.0;` ✓** *(10mV/C, so V = val*5/1024; C = V/0.01 = V*100)*\n",
          "c": "`temp = val / 1023.0;`",
          "d": "`temp = val * 10.0;`"
        },
        "correct": "b"
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          ...
          "c": "MQTT uses more bandwidth than HTTP",
...
const CN_MCQ_BANK = [
    ...
    "questions": [
      {
        ...
        "options": {
          "a": "30 links",
          "b": "**15 links ✓** *(Calculation: 6 * 5 / 2 = 15)*\n",
          "c": "6 links",
          "d": "5 links"
        },
        "correct": "b"
      ...
      {
        "id": 101,
        "question": "A military communication network connects 15 command centers in a fully mesh topology. If the military decides to add 5 more command centers to this network, how many new dedicated physical links must be added to keep the network fully meshed?",
        "options": {
          "a": "190 links",
          "b": "105 links",
          "c": "**85 links ✓** *(Calculation: Total links for 20 devices is 20 * 19 / 2 = 190. Total links for 15 devices was 15 * 14 / 2 = 105. New links = 190 - 105 = 85. Alternatively, each of the 5 new devices must connect to the 15 existing devices (5 * 15 = 75 links) and they must also connect among themselves (5 * 4 / 2 = 10 links), yielding 75 + 10 = 85 new links.)*\n",
          "d": "75 links"
        },
        "correct": "c"
      },
      {
        "id": 102,
        "question": "A campus network consists of three 8-port switches connected together in a linear daisy-chain (Switch A connected to Switch B, and Switch B connected to Switch C). A 12-port hub is connected to one of the ports of Switch A. All other remaining ports of the switches and the hub are connected directly to active client hosts. How many collision domains and broadcast domains exist in this network?",
        "options": {
          "a": "24 collision domains, 3 broadcast domains",
          "b": "**22 collision domains, 1 broadcast domain ✓** *(Calculation: 1) Broadcast domains: All devices are connected via Layer 2 switches and Layer 1 hubs, which do not break broadcast domains. Therefore, there is exactly 1 broadcast domain. 2) Collision domains: Each switch port represents a separate collision domain. Hubs do not segment collision domains; they form one single collision domain. Let's count: Switch A has 8 ports: 1 port connects to Switch B, 1 port connects to the Hub, and 6 ports connect to hosts (6 domains). Switch B has 8 ports: 1 port connects to Switch A, 1 port connects to Switch C, and 6 ports connect to hosts (6 domains). Switch C has 8 ports: 1 port connects to Switch B, and 7 ports connect to hosts (7 domains). The link between A and B is 1 domain. The link between B and C is 1 domain. The Hub and its 11 connected hosts share a single collision domain (1 domain). Total collision domains = 6 (hosts on A) + 6 (hosts on B) + 7 (hosts on C) + 1 (A-to-B link) + 1 (B-to-C link) + 1 (Hub domain) = 22 collision domains.)*\n",
          "c": "27 collision domains, 1 broadcast domain",
          "d": "8 collision domains, 8 broadcast domains"
        },
        "correct": "b"
      }
    ]
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          "a": "100 meters maximum length, Basic shielding",
      ...
      },
      {
        ...
        "options": {
          "a": "UTP provides better EMI shielding",
          "b": "**UTP is cheaper, more flexible, and easier to install ✓**",
          "c": "UTP has longer segment limits than STP",
          "d": "UTP does not require RJ-45 connectors"
        },
        "correct": "b"
      },
      {
        "id": 103,
        "question": "A noiseless communication channel has a bandwidth of 8 MHz. If we want to achieve a transmission bit rate of exactly 48 Mbps, what is the minimum number of distinct signal levels (L) required?",
        "options": {
          "a": "4 levels",
          "b": "**8 levels ✓** *(Calculation: According to the Nyquist Bit Rate formula: Bit Rate = 2 * Bandwidth * log2(L). Substituting the given values: 48 * 10^6 = 2 * 8 * 10^6 * log2(L) => 48 = 16 log2(L) => log2(L) = 3 => L = 2^3 = 8 levels.)*\n",
          "c": "16 levels",
          "d": "32 levels"
        },
        "correct": "b"
      ...
      {
        "id": 104,
        "question": "A telephone line is measured to have a bandwidth of 4 KHz. The signal-to-noise ratio (SNR) of the channel is determined to be 30 dB. What is the theoretical maximum channel capacity (C) of this link?",
        "options": {
          "a": "120 Kbps",
          "b": "**39.9 Kbps ✓** *(Calculation: 1) Convert SNR from decibels to linear scale: SNR_dB = 10 log10(SNR) => 30 = 10 log10(SNR) => SNR = 10^3 = 1000. 2) Apply Shannon's Capacity formula: C = Bandwidth * log2(1 + SNR) => C = 4000 * log2(1 + 1000) = 4000 * log2(1001). Since 2^10 = 1024 ≈ 1001, log2(1001) ≈ 9.97. Hence, C ≈ 4000 * 9.97 = 39,880 bps ≈ 39.9 Kbps.)*\n",
          "c": "40 Mbps",
          "d": "12 Kbps"
        },
        "correct": "b"
      ...
      {
        "id": 105,
        "question": "A noisy channel has a bandwidth of 2 MHz and a signal-to-noise ratio of 15 dB. What is the absolute maximum bit rate that can be achieved if we transmit data using a modulation scheme with 8 signal levels?",
        "options": {
          "a": "12 Mbps",
          "b": "**10.1 Mbps ✓** *(Calculation: 1) Calculate the Nyquist limit: Bit Rate = 2 * B * log2(L) = 2 * 2 * 10^6 * log2(8) = 12 Mbps. 2) Calculate the Shannon limit: SNR_dB = 15 => SNR = 10^1.5 ≈ 31.62. Apply Shannon's formula: C = B log2(1 + SNR) = 2 * 10^6 * log2(1 + 31.62) = 2 * 10^6 * log2(32.62). Since log2(32.62) ≈ 5.03, C ≈ 2 * 10^6 * 5.03 = 10.06 Mbps. 3) The maximum achievable bit rate is constrained by the Shannon limit, yielding 10.1 Mbps.)*\n",
          "c": "6 Mbps",
          "d": "24 Mbps"
        },
        "correct": "b"
      ...
      {
        "id": 106,
        "question": "A high-speed fiber-optic link connects two data centers separated by a distance of 2,000 km. The link has a bandwidth of 10 Gbps. The speed of light propagation inside the optical fiber is 2 * 10^8 m/s. What is the Bandwidth-Delay Product (BDP) of this link in bits?",
        "options": {
          "a": "200,000 bits",
          "b": "1,000,000 bits",
          "c": "**100,000,000 bits ✓** *(Calculation: 1) Calculate the one-way propagation delay (Tp): Tp = Distance / Speed = 2,000,000 m / (2 * 10^8 m/s) = 0.01 seconds (10 ms). 2) Calculate the BDP: BDP = Bandwidth * Tp = 10 * 10^9 bps * 0.01 s = 100,000,000 bits.)*\n",
          "d": "20,000,000 bits"
        },
        "correct": "c"
      },
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "id": 107,
        "question": "On a 1 Gbps CSMA/CD Ethernet network, the maximum propagation delay between any two stations is 25.6 microseconds. What is the minimum frame size required for proper collision detection?",
        "options": {
          "a": "64 bytes",
          "b": "512 bytes",
          "c": "**6,400 bytes ✓** *(Calculation: Frame transmission time must be at least twice the propagation delay: T_t >= 2 * T_p => Frame Size >= Bandwidth * 2 * T_p = 10^9 bps * 2 * 25.6 * 10^-6 s = 51,200 bits. In bytes: 51,200 / 8 = 6,400 bytes.)*\n",
          "d": "1,500 bytes"
        },
        "correct": "c"
      },
      {
        "id": 108,
        "question": "In a 10 Mbps Ethernet network, the standard inter-packet gap (IPG) is 9.6 microseconds. If a station transmits back-to-back frames of minimum size (64 bytes of payload/headers + 8 bytes of preamble and Start Frame Delimiter), what percentage of the total transmission channel time is consumed by the inter-packet gap?",
        "options": {
          "a": "9.60%",
          "b": "**14.29% ✓** *(Calculation: 1) Total minimum frame size with preamble = 72 bytes = 576 bits. 2) Transmission time T_t = 576 bits / 10 Mbps = 57.6 microseconds. 3) Total time slot = T_t + IPG = 57.6 + 9.6 = 67.2 microseconds. 4) Percentage consumed by IPG = 9.6 / 67.2 = 14.29%.)*\n",
          "c": "16.67%",
          "d": "12.00%"
        },
        "correct": "b"
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": {
          "a": "`0111`",
          "b": "**`1000` ✓** *(1011 + 1100 = 10111 => carry out 1; end-around carry: 0111 + 1 = 1000)*\n",
          "c": "`0110`",
          "d": "`1111`"
        },
        "correct": "b"
      ...
      },
      {
        ...
        "options": {
          "a": "Odd positions (1, 3, 5, 7)",
          "b": "**Positions that are powers of 2 (1, 2, 4) ✓**",
          "c": "Even positions (2, 4, 6)",
          "d": "Prime positions (2, 3, 5, 7)"
        },
        "correct": "b"
      },
      {
      ...
      },
      {
        ...
        "options": {
          "a": "`1011`",
          "b": "**`1101` ✓** *(powers: 3, 2, 0 present => 1 1 0 1)*\n",
          "c": "`1110`",
          "d": "`1001`"
        },
        "correct": "b"
      ...
      {
        "id": 109,
        "question": "A sender wants to transmit the 4-bit dataword 1011 using a 7-bit Hamming code with Even Parity. What is the resulting 7-bit codeword?",
        "options": {
          "a": "1011111",
          "b": "**1010101 ✓** *(Calculation: 1) Set up bit positions: Pos 7: d4=1, Pos 6: d3=0, Pos 5: d2=1, Pos 4: p4, Pos 3: d1=1, Pos 2: p2, Pos 1: p1. 2) Calculate parity (even): p1 checks 1,3,5,7 => p1 ⊕ 1 ⊕ 1 ⊕ 1 = 0 => p1 = 1. p2 checks 2,3,6,7 => p2 ⊕ 1 ⊕ 0 ⊕ 1 = 0 => p2 = 0. p4 checks 4,5,6,7 => p4 ⊕ 1 ⊕ 0 ⊕ 1 = 0 => p4 = 0. Codeword is [1,0,1,0,1,0,1] = 1010101.)*\n",
          "c": "1011001",
          "d": "1100101"
        },
        "correct": "b"
      ...
      {
        "id": 110,
        "question": "A receiver receives the 7-bit Hamming codeword 1011111. Assuming even parity was used at the transmitter, which bit position contains the transmission error, and what is the corrected codeword?",
        "options": {
          "a": "Position 3 contains the error; Corrected: 1010111",
          "b": "**Position 6 contains the error; Corrected: 1111111 ✓** *(Calculation: 1) Received: b7=1, b6=0, b5=1, b4=1, b3=1, b2=1, b1=1. 2) Parity checks: c1 = b1 ⊕ b3 ⊕ b5 ⊕ b7 = 1 ⊕ 1 ⊕ 1 ⊕ 1 = 0. c2 = b2 ⊕ b3 ⊕ b6 ⊕ b7 = 1 ⊕ 1 ⊕ 0 ⊕ 1 = 1. c4 = b4 ⊕ b5 ⊕ b6 ⊕ b7 = 1 ⊕ 1 ⊕ 0 ⊕ 1 = 1. 3) Syndrome = c4 c2 c1 = 110 (binary) = 6 (decimal). Error is at position 6. Corrected codeword is 1111111.)*\n",
          "c": "Position 5 contains the error; Corrected: 1001111",
          "d": "No error is detected; Codeword is 1011111"
        },
        "correct": "b"
      },
      {
        "id": 111,
        "question": "A sender wants to transmit the dataword 1001 using a Cyclic Redundancy Check (CRC) with a generator polynomial of G(x) = x^3 + x + 1. What is the final codeword transmitted?",
        "options": {
          "a": "1001011",
          "b": "1001000",
          "c": "**1001110 ✓** *(Calculation: 1) Divisor G(x) = 1011 (length 4, r=3). 2) Pad dataword: 1001000. 3) Modulo-2 division: 1001000 XOR 1011000 = 0010000. Next, 0010000 XOR 0010110 = 0000110. Remainder is 110. 4) Codeword = 1001000 + 110 = 1001110.)*\n",
          "d": "1001101"
        },
        "correct": "c"
      },
      {
        "id": 112,
        "question": "A receiver receives the codeword 1011011. The generator divisor used is 1001. Is the received codeword correct, and what is the remainder of the check?",
        "options": {
          "a": "Yes, correct; Remainder is 000",
          "b": "**No, error detected; Remainder is 001 ✓** *(Calculation: Modulo-2 division on received codeword: 1011011 XOR 1001000 = 0010011. Then 0010011 XOR 0010010 = 0000001. Remainder is 001. Since the remainder is non-zero, an error has occurred.)*\n",
          "c": "No, error detected; Remainder is 011",
          "d": "Yes, correct; Remainder is 101"
        },
        "correct": "b"
      },
      {
        "id": 113,
        "question": "A sender is transmitting two 8-bit data blocks: 10110101 and 01101110. What is the 8-bit Internet Checksum value that will be appended to the transmission?",
        "options": {
          "a": "00100100",
          "b": "**11011011 ✓** *(Calculation: 1) Sum blocks in One's Complement addition: 10110101 + 01101110 = 100100011 (9-bit sum, carry is 1). Add carry back: 00100011 + 1 = 00100100. 2) Checksum is complement of sum: ~00100100 = 11011011.)*\n",
          "c": "11011010",
          "d": "11111111"
        },
        "correct": "b"
      ...
      {
        "id": 114,
        "question": "A Slotted ALOHA channel operates with a bandwidth of 200 Kbps. Every frame transmitted is exactly 1000 bits. If the channel is operating at its maximum theoretical throughput, how many successful frames are transmitted per second?",
        "options": {
          "a": "200 frames/sec",
          "b": "36.8 frames/sec",
          "c": "**73.6 frames/sec ✓** *(Calculation: 1) Frame transmission time T_fr = 1000 bits / 200 Kbps = 0.005 seconds. 2) Max efficiency of Slotted ALOHA is 36.8% (0.368). 3) Successful frames per second = 0.368 / 0.005 s = 73.6 frames/second.)*\n",
          "d": "18.4 frames/sec"
        },
        "correct": "c"
      },
      {
        "id": 115,
        "question": "In a CDMA system, four stations (A, B, C, D) are assigned orthogonal chip sequences: A=[+1,+1,+1,+1], B=[+1,-1,+1,-1], C=[+1,+1,-1,-1], D=[+1,-1,-1,+1]. If the combined signal received on the channel is S = [-1, -3, +1, -1], what did Station B and Station C transmit, respectively?",
        "options": {
          "a": "Station B transmitted 0; Station C transmitted 1",
          "b": "**Station B transmitted 1; Station C transmitted 0 ✓** *(Calculation: Calculate inner product and divide by N=4. For B: S·B = (-1)(1) + (-3)(-1) + (1)(1) + (-1)(-1) = -1 + 3 + 1 + 1 = 4. Result = 4/4 = +1 (bit 1). For C: S·C = (-1)(1) + (-3)(1) + (1)(-1) + (-1)(-1) = -1 - 3 - 1 + 1 = -4. Result = -4/4 = -1 (bit 0).)*\n",
          "c": "Station B transmitted 1; Station C transmitted 1",
          "d": "Station B transmitted 0; Station C transmitted 0"
        },
        "correct": "b"
      },
      {
    ...
    "questions": [
      {
        ...
        "options": {
          "a": "50%",
          "b": "**25% ✓** *(a = 3/2 = 1.5; Eff = 1/(1+2(1.5)) = 1/4 = 25%)*\n",
          "c": "33%",
          "d": "20%"
        },
        "correct": "b"
      ...
      },
      {
        ...
        "options": {
          "a": "MF = 1",
          "b": "**MF = 0 ✓** *(indicates no more fragments follow)*\n",
          "c": "MF = 2",
          "d": "MF is omitted"
        },
        "correct": "b"
      ...
      {
        "id": 116,
        "question": "A Stop-and-Wait ARQ protocol is implemented on a 2 Mbps satellite link with a one-way propagation delay of 250 ms. The data frame size is 1,000 bytes. What is the link efficiency (utilization)?",
        "options": {
          "a": "50.0%",
          "b": "**0.79% ✓** *(Calculation: 1) Transmission time T_t = (1000 * 8 bits) / 2 Mbps = 4 ms (0.004 s). 2) Propagation delay T_p = 250 ms. 3) Efficiency = T_t / (T_t + 2*T_p) = 4 ms / (4 ms + 500 ms) = 4 / 504 = 0.793% ≈ 0.79%.)*\n",
          "c": "1.58%",
          "d": "8.00%"
        },
        "correct": "b"
      ...
      {
        "id": 117,
        "question": "A 10 Mbps point-to-point link has a one-way propagation delay of 20 ms. The frame size is 1250 bytes. If a network designer wants to run Go-Back-N ARQ and achieve at least 80% link utilization, what is the minimum number of bits (k) required in the sequence number field?",
        "options": {
          "a": "4 bits",
          "b": "5 bits",
          "c": "**6 bits ✓** *(Calculation: 1) Transmission time T_t = (1250 * 8) / 10M = 1 ms. 2) a = T_p / T_t = 20 ms / 1 ms = 20. 3) Utilization limit: W_s >= 0.8 * (1 + 2a) => W_s >= 0.8 * 41 = 32.8 => W_s >= 33. 4) GBN max window: W_s = 2^k - 1 => 2^k - 1 >= 33 => 2^k >= 34 => k >= 6.)*\n",
          "d": "7 bits"
        },
        "correct": "c"
      },
      {
        "id": 118,
        "question": "In a Selective Repeat ARQ protocol, the sequence numbers are represented by 4 bits. What is the maximum sender window size (Ws) that will prevent the receiver from confusing a retransmitted frame with a new frame?",
        "options": {
          "a": "15 frames",
          "b": "16 frames",
          "c": "**8 frames ✓** *(Calculation: In Selective Repeat, to avoid ambiguity, W_s + W_r <= 2^k. Since W_s = W_r, we have 2 * W_s <= 2^k => W_s <= 2^(k-1). For k=4, W_s <= 2^3 = 8 frames.)*\n",
          "d": "7 frames"
        },
        "correct": "c"
      },
      {
        "id": 119,
        "question": "An organization is allocated the CIDR block address 172.16.42.0/26. What is the subnet mask of this block, and how many usable host IP addresses are available in this subnet?",
        "options": {
          "a": "255.255.255.128 mask, 126 usable hosts",
          "b": "**255.255.255.192 mask, 62 usable hosts ✓** *(Calculation: 1) Suffix /26 means 26 bits set in mask => 255.255.255.192. 2) Host bits h = 32 - 26 = 6. 3) Usable hosts = 2^h - 2 = 2^6 - 2 = 62 hosts (excluding network 172.16.42.0 and broadcast 172.16.42.63).)*\n",
          "c": "255.255.255.224 mask, 30 usable hosts",
          "d": "255.255.255.192 mask, 64 usable hosts"
        },
        "correct": "b"
      },
      {
        "id": 120,
        "question": "A host on a local network has the IP address 192.168.10.142 and the subnet mask is set to 255.255.255.240. What is the network address (first address) and the broadcast address (last address) of the subnet block to which this host belongs?",
        "options": {
          "a": "Network: 192.168.10.128; Broadcast: 192.168.10.135",
          "b": "**Network: 192.168.10.128; Broadcast: 192.168.10.143 ✓** *(Calculation: 1) Mask 255.255.255.240 is /28. 2) Block size = 256 - 240 = 16. 3) Multiples of 16 closest to 142 are 128 and 144. So the host lies in range 128 to 143. Network IP is 192.168.10.128, Broadcast IP is 192.168.10.143.)*\n",
          "c": "Network: 192.168.10.140; Broadcast: 192.168.10.155",
          "d": "Network: 192.168.10.128; Broadcast: 192.168.10.159"
        },
        "correct": "b"
      },
      {
        "id": 121,
        "question": "A business is assigned a Class C network IP address of 198.51.100.0. The IT department needs to divide this network into at least 12 subnets, with each subnet containing at least 10 hosts. What subnet mask should the business use?",
        "options": {
          "a": "255.255.255.192",
          "b": "**255.255.255.240 ✓** *(Calculation: Class C defaults to /24 (8 bits for host/subnet). We need S subnet bits: 2^S >= 12 => S >= 4. We need H host bits: 2^H - 2 >= 10 => H >= 4. Since S + H = 8, we must choose S=4 and H=4. New mask is /28 => 255.255.255.240.)*\n",
          "c": "255.255.255.224",
          "d": "255.255.255.248"
        },
        "correct": "b"
      ...
      {
        "id": 122,
        "question": "An IPv4 packet with a total size of 3200 bytes (including a 20-byte IP header) must pass through a link with an MTU (Maximum Transmission Unit) of 1200 bytes. What are the Total Length, More Fragments (MF) flag, and Fragment Offset (in 8-byte units) for the second fragment?",
        "options": {
          "a": "Length: 1200 bytes; MF: 1; Offset: 150",
          "b": "**Length: 1196 bytes; MF: 1; Offset: 147 ✓** *(Calculation: MTU=1200. Max payload = 1180. Offset must be a multiple of 8, so max payload payload-multiple is 1176 (147 * 8). Fragment 1: Length=1196, MF=1, Offset=0. Fragment 2: Length=1196, MF=1, Offset=1176/8=147. Fragment 3: Length=848, MF=0, Offset=294. Hence fragment 2 has length 1196, MF=1, Offset=147.)*\n",
          "c": "Length: 1200 bytes; MF: 0; Offset: 147",
          "d": "Length: 1176 bytes; MF: 1; Offset: 294"
        },
        "correct": "b"
      },
      {
        "id": 123,
        "question": "A router receives a packet fragment with a Fragment Offset of 300 and a Total Length of 600 bytes (including a 20-byte IP header). What byte range of the original IP packet's payload does this fragment contain?",
        "options": {
          "a": "Bytes 300 to 900",
          "b": "**Bytes 2400 to 2979 ✓** *(Calculation: 1) Starting byte = Offset * 8 = 300 * 8 = 2400. 2) Payload size = Total Length - Header = 600 - 20 = 580 bytes. 3) Byte range is 2400 to 2400 + 580 - 1 = 2979.)*\n",
          "c": "Bytes 2400 to 3000",
          "d": "Bytes 300 to 879"
        },
        "correct": "b"
      },
      {
        "id": 124,
        "question": "A core router needs to summarize the four routing table entries: 203.0.112.0/24, 203.0.113.0/24, 203.0.114.0/24, and 203.0.115.0/24 into a single summary route. What is the summarized CIDR block address?",
        "options": {
          "a": "203.0.112.0/24",
          "b": "**203.0.112.0/22 ✓** *(Calculation: Changing octet is the third: 112 (01110000), 113 (01110001), 114 (01110010), 115 (01110011). First 6 bits match. Mask = 8 + 8 + 6 = 22. Summarized address is 203.0.112.0/22.)*\n",
          "c": "203.0.112.0/23",
          "d": "203.0.110.0/22"
        },
        "correct": "b"
      ...
      {
        "id": 125,
        "question": "A sender uses Go-Back-N ARQ with a window size of 7 over a 1 Mbps point-to-point link. If the one-way propagation delay of the link is 15 ms, what is the minimum frame size (in bits) required to achieve 100% link utilization?",
        "options": {
          "a": "1,000 bits",
          "b": "**5,000 bits ✓** *(Calculation: 1) For 100% utilization, W_s >= 1 + 2a => 7 >= 1 + 2 * (15 ms / T_t) => 6 >= 30 ms / T_t => T_t >= 5 ms. 2) Frame size L = T_t * Bandwidth = 0.005 s * 1,000,000 bps = 5000 bits.)*\n",
          "c": "4,200 bits",
          "d": "7,000 bits"
        },
        "correct": "b"
