...
const LINUX_BASH_PROBLEMS = [
  ...
  },
  {
    ...
    source: "Linux_Organized_Prep.md",
    prompt: "Ernq n zrah pubvpr naq gjb ahzoref. Hfr 1=Nqq, 2=Fhogenpg, 3=Zhygvcyl, 4=Qvivqr.\aRknzcyr jbexsybj: \aPubvpr: 1\aAhzoref: 10 5\aBhgchg: Fhz = 15",
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq a\asbe v va {1..10}; qb\a  rpub \"$a k $v = $((a * v))\"\aqbar\a",
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq a\asbe ((v=1; v<=a; v++)); qb\a  vs [ $((v % 15)) -rd 0 ]; gura\a    rpub \"SvmmOhmm\"\a  ryvs [ $((v % 3)) -rd 0 ]; gura\a    rpub \"Svmm\"\a  ryvs [ $((v % 5)) -rd 0 ]; gura\a    rpub \"Ohmm\"\a  ryfr\a    rpub \"$v\"\a  sv\aqbar\a",
    examples: [{ input: "5\n", expectedOutput: "1\n2\nFizz\n4\nBuzz\n" }],
    tests: [
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq a\asbe ((v=1; v<=a; v++)); qb\a  ebj=\"\"\a  sbe ((w=1; w<=v; w++)); qb\a    ebj=\"${ebj}*\"\a  qbar\a  rpub \"$ebj\"\aqbar\a",
    examples: [{ input: "3\n", expectedOutput: "*\n**\n***\n" }],
    tests: [
  ...
  },
  {
    ...
    source: "Linux_Organized_Prep.md",
    prompt: "Ernq n ahzore naq cevag vgf fhz bs qvtvgf, erirefr, naq gur snpgbevny bs gur fhz bs qvtvgf.",
    constraints: ["Input contains one positive integer.", "Print three labeled lines."],
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq a\afhz=0\agrzc=$a\ajuvyr [ $grzc -tg 0 ]; qb\a  qvtvg=$((grzc % 10))\a  fhz=$((fhz + qvtvg))\a  grzc=$((grzc / 10))\aqbar\aeri=0\agrzc=$a\ajuvyr [ $grzc -tg 0 ]; qb\a  qvtvg=$((grzc % 10))\a  eri=$((eri * 10 + qvtvg))\a  grzc=$((grzc / 10))\aqbar\asnpg=1\asbe ((v=1; v<=fhz; v++)); qb\a  snpg=$((snpg * v))\aqbar\arpub \"Fhz = $fhz\"\arpub \"Erirefr = $eri\"\arpub \"Snpgbevny = $snpg\"\a",
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq a\an=0\ao=1\abhg=\"\"\asbe ((v=0; v<a; v++)); qb\a  bhg=\"$bhg $n\"\a  sa=$((n + o))\a  n=$o\a  o=$sa\aqbar\arpub \"${bhg:1}\"\a",
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq n o p\avs [ $n -tg $o ]; gura g=$n; n=$o; o=$g; sv\avs [ $n -tg $p ]; gura g=$n; n=$p; p=$g; sv\avs [ $o -tg $p ]; gura g=$o; o=$p; p=$g; sv\arpub \"$n $o $p\"\a",
  ...
  },
  {
    ...
    starterCode: EMPTY_BASH_STARTER,
    solutionCode: "#!/hfe/ova/rai onfu\aernq fge cbf yra\arpub \"${fge:$cbf:$yra}\"\a",
